...
namespace Sunny
{
    static class WebDelegate
    {
        ...
        {
            WebRT.OnBindCLRObjToWebPage += Cosmos_OnBindCLRObjToWebPage;
            WebRT.OnGetSubObjForWebPage += Tangram_OnGetSubObjForWebPage;
            WebRT.OnWebRTMsg += Cosmos_OnHubbleMsg;
            WebRT.OnCustomizedDOMElement += Cosmos_OnCustomizedDOMElement;
            WebRT.OnWebRTMsgReceived += Cosmos_OnHubbleMsgReceived;
            return 0;
        }
